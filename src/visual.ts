...
export class Visual implements IVisual {
    ...
    //     d3.json(".files/states.json", function (error: any, us: any) {  if (error) throw error; 
    ...
    //          .attr("d", path)
    //          .attr("class", "feature")
    //          .on("click", clicked); g.append("path")
    //          .datum(topojson.mesh(us, us.objects.states, (a: any, b: any) => a !== b)).attr("class", "mesh"); }); 
             
             
    //     function reset() { active.classed("active", false);
    //     // active = d3.select(null);
    ...
    // function clicked() {if (active.node() === this) return reset();
    //     active.classed("active", false);
    //     active = d3.select(this).classed("active", true);
